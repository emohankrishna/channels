...
func (shop *BarberShop) cutHair(barber, client string) {
	color.HiCyan("%s is cutting %s's hair", barber, client)
...
func (shop *BarberShop) CloseShopForDay() {
	...
	color.Red("------------------------------------------------------------")
	color.Red("Barber is now closed for the day, and everyone has gone home.")
}

func (shop *BarberShop) AddClients(client string) {
